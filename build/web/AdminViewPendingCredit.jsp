...
<% 
    ...
    try {
       ...
       ResultSet rs = stmt.executeQuery("SELECT creditb.*, users.names, users.email, users.phone FROM creditb JOIN users ON creditb.userid = users.userid WHERE creditb.status = 'pending'");
...
%>
            <tr>
                ...
                <td>
                     <a href="UpdatePendingCreditRequest.jsp?creditid=<%= creditId %>" class="action-update">Update</a>
                </td>
            </tr>
<% 
        }
...
%>
        ...
        <!-- Display total credit requested -->
        <div style="margin-top: 20px;">
            <strong>Total Credit Requested: <%= totalCreditRequested %> Frw</strong>
        </div>
        </div>
    </main>
</div>
