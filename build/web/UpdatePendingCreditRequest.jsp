  ...
  <header>
    ...
    <%
        ...
        if (userIdStr != null) {
            ...
            String amountRequested = ""; // Initialize the username
            ...
            try {
                ...
                String query = "SELECT requestedamount,status,paystatus FROM creditb WHERE creditid=?";
                ...
                if (resultSet.next()) {
                    amountRequested = resultSet.getString("requestedamount");
                    requestStatus = resultSet.getString("status");
    ...
    %>
                ...
                <form action="updatePendingCredit" method="post">
                    <input type="hidden" id="title" name="userid" value="<%= creditid %>" required>
                    <label for="title">Amount:</label>
                    <input type="text" id="title" name="name" value="<%= amountRequested %>" required disabled>
                    <label for="title">Status:</label>
                    <input type="text" id="title" name="email" value="<%= requestStatus %>" required disabled>
                    <label for="title">Pay Status:</label>
                    <input type="text" id="title" name="location" value="<%= payStatus %>" required disabled>
    ...
    <% String status = request.getParameter("updatesuccess"); %>
    <% if (status != null) { %>
