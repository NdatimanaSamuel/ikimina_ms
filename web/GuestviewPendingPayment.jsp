        ...
        Statement stmt = conn.createStatement();
         int count = 0;
                        ...
                        if (userResultSet.next()) {
                            ...
                            ResultSet savingResultSet = stmt.executeQuery("SELECT * FROM savingtb WHERE userid = " + session.getAttribute("userId") + " ORDER BY savingid DESC");

                            while (savingResultSet.next()) {
                                String savId = savingResultSet.getString("savingid");
