  ...
  <header>
    ...
    <%
        ...
        if (userIdStr != null) {
            ...
            try {
                ...
                String query = "SELECT names,email,location,phone FROM users WHERE userid=?";
                ...
                if (resultSet.next()) {
                    ...
                    userLoaction = resultSet.getString("location");
    ...
    %>
                ...
                <form action="UpdateUserProfile" method="post">
                    ...
                    <input type="text" id="title" name="email" value="<%= userEmail %>" required>
                    <label for="title">Location:</label>
                    <input type="text" id="title" name="location" value="<%= userLoaction %>" required>
                    <label for="title">Phone</label>
                    <input type="text" id="title" name="phone" value="<%= userPhone %>" required>
