   ...
   <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="UpdateUserProfile.jsp?userId=<%= userId %>" class="action-update">Update</a>
<!--                   <a href="#" onclick="confirmDelete(<%= userId %>)" class="action-delete">Delete</a>-->
                   <a href="deleteUser?userId=<%= userId %>" class="action-delete" onclick="return confirm('Are you sure you want to delete this user?');">Delete</a>
     ...
     <footer>
        ...
        if (status === 'success') {
            Swal.fire({
                ...
                text: 'The user has been Upadted successfully.',
