...
public class viewAllUserServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // Execute a query
            resultSet = statement.executeQuery("SELECT * FROM users where type='guest' ORDER BY userid DESC");
            // Store the result set in the request as an attribute
            request.setAttribute("resultSet", resultSet);
            // Forward the request to the JSP page
            RequestDispatcher dispatcher = request.getRequestDispatcher("viewAllUser.jsp");
